...
- **🚫 No Cookies**: No authentication (public videos only, age-restricted content will fail)""",
    ...
    "notification_cleanup_title": "Clean up recommended",
    "notification_cleanup_message": 'HomeTube v2.6 introduces a new temporary files organization. Consider cleaning up old temporary files from the HomeTube left sidebar or "Advanced Options" to benefit from the improved structure.',
    "notification_cleanup_action": "Learn more",
    "notification_dismiss": "Dismiss this notification",
